    ...
    for (loopIndex = 0; loopIndex < NUM_ACTIVE_PADDLE_BOATS; loopIndex++) {
        ...
        if (tempPaddleWheelBoat->isActive == 1) {
            ...
            tempPaddleWheelBoat->rotY = update_vehicle_following_waypoint(
                tempPaddleWheelBoat->position, (s16*) &tempPaddleWheelBoat->waypointIndex, tempPaddleWheelBoat->speed);
            ...
            tempPaddleWheelBoat->actorIndex = add_actor_to_empty_slot(tempPaddleWheelBoat->position, paddleWheelBoatRot,
