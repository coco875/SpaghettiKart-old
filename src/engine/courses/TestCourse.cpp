...
void TestCourse::SpawnVehicles() {
    ...
    gWorldInstance.AddObject(new OBombKart(pos, &gTrackPaths[0][25], 25, 4, 0.8333333f));
    gWorldInstance.AddObject(new OBombKart(pos, &gTrackPaths[0][45], 45, 4, 0.8333333f));
}
