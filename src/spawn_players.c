...
void func_8003C0F0(void) {
    ...
    if ((gModeSelection != BATTLE) && (gCurrentCourseId != COURSE_AWARD_CEREMONY)) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_1P:
                switch (gModeSelection) {
                    case GRAND_PRIX:
    ...
    } else if (gCurrentCourseId == COURSE_BLOCK_FORT) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 5;
    ...
    } else if (gCurrentCourseId == COURSE_SKYSCRAPER) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0x1E0;
    ...
    } else if (gCurrentCourseId == COURSE_DOUBLE_DECK) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0x37;
    ...
    } else if (gCurrentCourseId == COURSE_BIG_DONUT) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0xC8;
