...
void spawn_players_2p_battle(f32* arg0, f32* arg1, f32 arg2) {
    if (gCurrentCourseId == GetBigDonut()) {
...
void func_8003C0F0(void) {
    ...
    if (gModeSelection == BATTLE) {
        func_8000EEDC();
    } else if (gCurrentCourseId != GetPodiumCeremony()) {
        func_8000F2DC();
    ...
    if ((gModeSelection != BATTLE) && (gCurrentCourseId != GetPodiumCeremony())) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_1P:
                switch (gModeSelection) {
                    case GRAND_PRIX:
    ...
    } else if (gCurrentCourseId == GetBlockFort()) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 5;
    ...
    } else if (gCurrentCourseId == GetSkyscraper()) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0x1E0;
    ...
    } else if (gCurrentCourseId == GetDoubleDeck()) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0x37;
    ...
    } else if (gCurrentCourseId == GetBigDonut()) {
        switch (gActiveScreenMode) {
            case SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL:
            case SCREEN_MODE_2P_SPLITSCREEN_VERTICAL:
                temp = 0xC8;
