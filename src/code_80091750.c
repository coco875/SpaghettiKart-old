...
int* gCupSelectionByCourseId[NUM_COURSES] = {
...
#define gCupSelectionByCourseId *gCupSelectionByCourseId
...
void func_8009CE64(s32 arg0) {
    ...
    func_8009CE64_label1:
        ...
        if (gDebugMenuSelection != 0x40) {
            ...
            if (gCurrentCourseId == COURSE_BLOCK_FORT || gCurrentCourseId == COURSE_SKYSCRAPER ||
                gCurrentCourseId == COURSE_DOUBLE_DECK || gCurrentCourseId == COURSE_BIG_DONUT) {
