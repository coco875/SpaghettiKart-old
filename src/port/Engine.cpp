...
GameEngine::GameEngine() {
    ...
    // loader->RegisterResourceFactory(std::make_shared<LUS::ResourceFactoryBinaryLightsV0>(), RESOURCE_FORMAT_BINARY,
    // "Lights1", static_cast<uint32_t>(LUS::ResourceType::Lights), 0);
